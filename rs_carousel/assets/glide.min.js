...
! function(a, b, c, d) {
    var e = function(a, b) {
            function c() {}
            var d;
            return c.prototype.make = function(c) {
                return b.Run.canProcess() ? (d = "undefined" != typeof c ? parseInt(c) : 0, this[a.options.type](), this) : b.Arrows.disable()
        ...
        f = function(a, b) {
            ...
            return c.prototype.instance = function() {
                return {
                    ...
                    destroy: function() {
                        b.Run.pause(), b.Clones.remove(), b.Helper.removeStyles([a.track, a.slides]), b.Bullets.remove(), a.slider.removeData("glide_api"), b.Events.unbind(), b.Touch.unbind(), b.Arrows.unbind(), b.Bullets.unbind(), a.destroyed = !0, delete a.slider, delete a.track, delete a.slides, delete a.width, delete a.length
                    },
                    refresh: function() {
        ...
        g = function(b, c) {
            ...
            return d.prototype.build = function() {
                ...
                return a ? void this.items.filter("." + d["arrow" + c.Helper.capitalise(a)]).unbind("click.glide touchstart.glide").addClass(d.disabled).siblings().bind("click.glide touchstart.glide", this.click).bind("mouseenter.glide", this.hover).bind("mouseleave.glide", this.hover).removeClass(d.disabled) : this.disableBoth()
            }, d.prototype.disableBoth = function() {
                this.items.unbind("click.glide touchstart.glide").addClass(b.options.classes.disabled)
        ...
        l = function(c, d) {
            function e() {
                this.disabled = !1, this.prevented = !1, this.keyboard(), this.hoverpause(), this.resize(), this.bindTriggers(), this.bindAnchors(), this.bindImages()
            }
            ...
            return e.prototype.keyboard = function() {
                ...
                a(b).on("resize.glide." + c.uuid, d.Helper.throttle(function() {
                    c.destroyed || (d.Transition.jumping = !0, c.setup(), d.Build.init(), d.Run.make("=" + c.current, !1), d.Run.play(), d.Transition.jumping = !1)
                }, c.options.throttle))
            ...
            }, e.prototype.bindAnchors = function() {
                c.track.on("click.glide", "a", function(a) {
                    this.prevented && a.preventDefault()
                }.bind(this))
            }, e.prototype.bindImages = function() {
                c.track.on("dragstart.glide", "img", function(a) {
                    this.prevented && a.preventDefault()
                }.bind(this))
            }, e.prototype.detachClicks = function(b) {
                return c.track.find("a").each(function(b, c) {
                    a(c).attr("data-href", a(c).attr("href")).removeAttr("href")
                }), this
            }, e.prototype.attachClicks = function(b) {
                return c.track.find("a").each(function(b, c) {
                    a(c).attr("href", a(c).attr("data-href")).removeAttr("data-href")
                }), d.Animation.after(function() {
                    this.prevented = !1
                }.bind(this)), this
            }, e.prototype.preventClicks = function() {
                return this.prevented = !0, this
                ...
                c.track.off("click.glide", "a").off("dragstart.glide", "img").off("keyup.glide").off("mouseover.glide").off("mouseout.glide"), f.off("click.glide touchstart.glide"), a(b).off("keyup.glide").off("resize.glide." + c.uuid)
        ...
        m = function(a, b) {
            ...
            return c.prototype.get = function() {
                ...
                return !(!a.options.autoheight && !b) && a.wrapper.height(this.get())
            }, new c
        },
        n = function(a, b) {
            function c() {}
            return c.prototype.byAxis = function(b, c) {
                ...
                return function() {
                    ...
                    i || c.leading !== !1 || (i = k);
                    var l = b - (k - i);
                    return d = this, e = arguments, l <= 0 || l > b ? (h && (clearTimeout(h), h = null), i = k, f = a.apply(d, e), h || (d = e = null)) : h || c.trailing === !1 || (h = setTimeout(j, l)), f
                }
        ...
        o = function(a, b) {
            ...
            return c.prototype.play = function() {
                var b = this;
                if (this.canProcess()) return (a.options.autoplay || this.running) && "undefined" == typeof this.interval && (this.interval = setInterval(function() {
                ...
                var e = this;
                if (this.direction = c.substr(0, 1), this.steps = c.substr(1) ? c.substr(1) : 0, !this.canProcess()) return this.stop();
                switch (a.options.hoverpause || this.pause(), d !== !1 && b.Events.disable().call(a.options.beforeTransition).trigger("beforeTransition"), this.direction) {
                    case ">":
                ...
                this.pause()
            }, c.prototype.canProcess = function() {
                return a.slides.length > 1
            }, new c
        },
        p = function(b, c) {
            function d() {
                this.dragging = !1, b.options.touchDistance && b.track.on({
            ...
            return d.prototype.unbind = function() {
                ...
                if (!c.Events.disabled && this.dragging) {
                    ...
                    if (this.touchSin = Math.asin(j / i), this.distance = c.Helper.byAxis(e.pageX - this.touchStartX, e.pageY - this.touchStartY), 180 * this.touchSin / Math.PI < 45 && c.Animation.make(c.Helper.byAxis(d, f)), c.Events.preventClicks().call(b.options.swipeMove).trigger("swipeMove"), c.Build.isMode("vertical")) {
                        if (c.Run.isStart() && f > 0) return;
                        if (c.Run.isEnd() && f < 0) return
                    }
                ...
                if (!c.Events.disabled && this.dragging) {
                    ...
                    c.Transition.jumping = !1, c.Build.isType("slider") && (c.Run.isStart() && f > 0 && (f = 0), c.Run.isEnd() && f < 0 && (f = 0)), d = "mouseup" === a.type || "mouseleave" === a.type ? b.options.dragDistance : b.options.touchDistance, f > d && g < 45 ? c.Run.make("<") : f < -d && g < 45 ? c.Run.make(">") : c.Animation.make(), c.Animation.after(function() {
        ...
        s = function(b, c) {
            ...
            this.options = a.extend({}, d, c), this.uuid = Math.floor(1e3 * Math.random()), this.current = parseInt(this.options.startAt), this.element = b, this.collect(), this.setup(), this.destroyed = !1, this.options.beforeInit({
                index: this.current,
